...
window.define(["jquery"],
    (function ($) {
         ...
         *
         */
        var HtmlController = function (scene, animation, keyMap, robotAnimation) {
            ...
            var updateParams = function () {
                ...
                if ($("#anim_Toggle").attr("checked") === undefined) {
                    if ($("#drawOpt_Show_Robot").attr("checked") === undefined) {
                        animation.stop();
                    } else {
                        robotAnimation.stop();
                    }
                ...
                for (var o in scene.drawOptions) {
                    ...
                    scene.drawOptions[o] = $(element_selector).prop("checked");
                }
